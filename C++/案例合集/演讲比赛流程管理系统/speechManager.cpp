...
void SpeechManager::speechContest()
{
	...
	//准备临时容器 存放小组成绩
	multimap<double, int, greater<double>>groupScore;  //降序

	int num = 0;  //用于记录人员的个数  6人一组
	...
	for (vector<int>::iterator it = v_Src.begin(); it != v_Src.end(); it++)
	{
		...
		//打印平均分
		//cout << "编号：" << *it << " 姓名：" << this->m_Speaker[*it].m_Name << " 平局分：" << avg << endl;
...
void SpeechManager::saveRecord()
{
	...
	//将每个选手数据写入文件中
	for (vector<int>::iterator it = vVictoy.begin(); it != vVictoy.end(); it++)
	{
